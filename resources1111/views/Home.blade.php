                    ...
                    <div class="owl-carousel owl-banner">
                        <div class="item item-1">
                            <div class="header-text">
                                ...
                                <h2>With moufeed, Everything Is Easier</h2>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio tempore error
                                    repudiandae ullam in. Iure suscipit asperiores excepturi veniam, ab deleniti,
                                    repellendus, illum dolor nihil recusandae enim eveniet at praesentium.</p>
                            </div>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row event_box">
                ...
                <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6  development">
                    <div class="events_item">
                        <div class="thumb">
                            <a href="#"><img src="{{ asset('images/course-02.jpg') }}" alt=""></a>
                ...
                <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 design wordpress">
                    <div class="events_item">
                        <div class="thumb">
                            <a href="#"><img src="{{ asset('images/course-03.jpg') }}" alt=""></a>
                ...
                <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 development">
                    <div class="events_item">
                        <div class="thumb">
                            <a href="#"><img src="{{ asset('images/course-04.jpg') }}" alt=""></a>
                            <span class="category">Development</span>
                            <span class="price">
                                <h6><em>$</em>450</h6>
                            </span>
                ...
                <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress development">
                    <div class="events_item">
                        <div class="thumb">
                            <a href="#"><img src="{{ asset('images/course-05.jpg') }}" alt=""></a>
                            <span class="category">Wordpress</span>
                            <span class="price">
                                <h6><em>$</em>320</h6>
                            </span>
                ...
                <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress design">
                    <div class="events_item">
                        <div class="thumb">
                            <a href="#"><img src="{{ asset('images/course-06.jpg') }}" alt=""></a>
                            <span class="category">Webdesign</span>
                            <span class="price">
                                <h6><em>$</em>240</h6>
                            </span>
            ...
            <ul class="event_filter">
                    ...
                    <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress design">
                            <div class="events_item">
                                ...
                                <div class="down-content">
                                    <span class="author">David Hutson</span>
                                    <h4>Full Stack Developer</h4>
                                </div>{{ route('episode.create'  ,compact()  )}}
                                      {{ route('episode.create', ['id'=>1]) }}
                            </div>
                        </div>
                    </div>
                @endfor --}}
                {{-- @foreach ($cats as $cat)
                 <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 wordpress design">
                            <div class="events_item">
                                <div class="thumb">
                                    <a href="{{route('showcategorycourses.show' ,$cat->id)}}"><img src="{{ asset( 'storage/'.$cat->img) }}"></a>
                                ...
                                <div class="down-content">
                                    <span class="author">{{$cat->name}}</span>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="section-heading">
                        ...
                        <h2>The Last Courses </h2>
                        <h2>From Different Category`s </h2>
                    </div>
                </div>
            </div>
    </section>  --}}
           ...
           @foreach ($cats as $cat)
             <div class="row event_box">
                <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 design">
                    <div class="events_item">
                        <div class="thumb">
                            <a href="{{route('showcategorycourses.show' ,$cat->id)}}"><img src="{{ asset( 'storage/'.$cat->img) }}" alt="" height="300" width="300"/></a>
                            <span class="category">{{$cat->name}}</span>
                            <span class="price">
                                <h6><em></em>000</h6>
                            </span>
                        ...
                        <div class="down-content">
                            <span class="author">The Category {{$cat->name}}</span>
                            <h4> {{$cat->information}} </h4>
                        </div>
                    </div>
                </div>
            ...
            <div class="row event_box">
                  ...
                  @foreach ($lastcourses as $lastcourse)
                    ...
                    <div class="col-lg-4 col-md-6 align-self-center mb-30 event_outer col-md-6 design">
                      <div class="events_item">
                         <div class="thumb">
                            <a href="{{route('showdetailscourse.showDetailCourse' ,$lastcourse->id)}}"><img src="{{ asset( 'storage/'.$lastcourse->img) }}" alt="" height="300" width="300"/></a>
                            <span class="category">{{$lastcourse->duration}}</span>
                            <span class="price">
                                <h6><em>$</em>{{$lastcourse->price}}</h6>
                            </span>
                        </div>

                        <div class="down-content">
                            <span class="author"> {{$lastcourse->duration}}</span>
                            <span class="author"> ......... {{$lastcourse->price}} $</span>
                            <h4> {{$lastcourse->description}} </h4>
                            <br>
                            <a href="{{ route('cart.addCart' ,$lastcourse->id )}}">
