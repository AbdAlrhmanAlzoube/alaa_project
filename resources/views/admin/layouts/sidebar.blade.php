<div class="main-sidebar">
    <a title="link"side id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li ><a title="link" class="nav-link" href="index.html"><i class="fas fa-hand-point-right"></i> <span>Dashboard</span></a></li>
            ...
            <li ><a title="link" class="nav-link" href="addstudent.html"><i class="fas fa-hand-point-right"></i> <span>Add Student</span></a></li>

            
            <li><a title="link" class="nav-link" href="showstudent.html"><i class="fas fa-hand-point-right"></i> <span>Show Students</span></a></li>
